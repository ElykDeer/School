 ...
 *
 * This code serves as an exercise in seperate
 * compilation.
 *
 */
...
//Namespaces, Mine and Standard
using namespace BrooklynPoly;
using namespace std;

int main()
{
  cout << "### EXECUTING EXAMPLE CODE ###\n";
  ...
  cout << "### NOW READING FROM COMMAND FILE ###\n";
  //Read Trasaction Files
  registrar.readCommandFile();
}
