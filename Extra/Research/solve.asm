; Author: Kyle Martin
; I'm seriously going to reget this....
...
_start:
 ;What needs to happen:
  ;A random key needs to be generated
  ;The stack needs to be set up
  ;The hash function needs to be called
  ;The hash needs to be verified
 ;repeat
