...
class PList:
    ...
    def delete(self,p):
        ...
        if self._Flipped:
            ...
            node._next=node._prev=node._data=None
        else:
            node._prev._next=node._next
            node._next._prev=node._prev
    ...
    def __iadd__(self, other):
        if self._Flipped:
            #for i in list(other):
            #    print(i)
            self._head._next._prev = other._tail._prev
            other._tail._prev._next = self._head._next
            self._head._next = other._head._next
            other._head._next._prev = self._head
